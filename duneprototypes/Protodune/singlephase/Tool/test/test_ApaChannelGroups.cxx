// test_ApaChannelGroups.cxx
//
// David Adams
// July 2018
//
// Test ApaChannelGroups.
...
int test_ApaChannelGroups(bool useExistingFcl =false, int show =1) {
  const string myname = "test_ApaChannelGroups: ";
#ifdef NDEBUG
  ...
  string fclfile = "test_ApaChannelGroups.fcl";
  if ( ! useExistingFcl ) {
    ...
    fout << "  }" << endl;
    fout << "  mytool: {" << endl;
    fout << "    tool_type: ApaChannelGroups" << endl;
    fout << "    LogLevel: 2" << endl;
...
int main(int argc, char* argv[]) {
  ...
  return test_ApaChannelGroups(useExistingFcl, show);
}
